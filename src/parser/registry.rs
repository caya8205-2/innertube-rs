...
mod tests {
    ...
    fn test_all_ytnode_variants_have_executable_parsers() {
        let test_cases = [
            ...
            // Batch 12: Music & Page Headers
            (json!({ "musicResponsiveListItemFixedColumnRenderer": { "displayPriority": "HIGH" } }), "MusicResponsiveListItemFixedColumn"),
            (json!({ "musicResponsiveListItemFlexColumnRenderer": { "displayPriority": "LOW" } }), "MusicResponsiveListItemFlexColumn"),
            (json!({ "musicTastebuilderShelfRenderer": { "isVisible": true } }), "MusicTastebuilderShelf"),
            (json!({ "musicTastebuilderShelfThumbnailRenderer": { "thumbnail": {} } }), "MusicTastebuilderShelfThumbnail"),
            (json!({ "notificationActionRenderer": { "responseText": { "runs": [{ "text": "Done" }] } } }), "NotificationAction"),
            (json!({ "openOnePickAddVideoModalCommand": { "listId": "L1" } }), "OpenOnePickAddVideoModalCommand"),
            (json!({ "pageHeaderRenderer": { "pageTitle": "Page" } }), "PageHeader"),
            (json!({ "pageHeaderView": { "title": {} } }), "PageHeaderView"),
            (json!({ "pageIndicatorView": { "indicatorCount": 5 } }), "PageIndicatorView"),
            (json!({ "pageIntroductionRenderer": { "pageTitle": "Intro" } }), "PageIntroduction"),
            (json!({ "panelFooterView": { "shouldHideDivider": true } }), "PanelFooterView"),
            (json!({ "pivotButtonRenderer": { "targetId": "p1" } }), "PivotButton"),
            // Batch 12: Playlists & Products
            (json!({ "playlistAddToOptionRenderer": { "playlistId": "pl1" } }), "PlaylistAddToOption"),
            (json!({ "playlistCollaborationView": { "collaborationType": "COLLAB" } }), "PlaylistCollaborationView"),
            (json!({ "playlistCustomThumbnailRenderer": { "thumbnail": {} } }), "PlaylistCustomThumbnail"),
            (json!({ "playlistHeaderRenderer": { "id": "ph1" } }), "PlaylistHeader"),
            (json!({ "playlistInfoCardContentRenderer": { "videoCount": { "runs": [{ "text": "10 videos" }] } } }), "PlaylistInfoCardContent"),
            (json!({ "playlistPanelVideoWrapperRenderer": { "primary": {} } }), "PlaylistPanelVideoWrapper"),
            (json!({ "playlistSidebarRenderer": { "items": [] } }), "PlaylistSidebar"),
            (json!({ "playlistThumbnailOverlayRenderer": { "iconType": "PLAY" } }), "PlaylistThumbnailOverlay"),
            (json!({ "playlistVideoListRenderer": { "id": "pvl1" } }), "PlaylistVideoList"),
            (json!({ "playlistVideoThumbnailRenderer": { "thumbnail": {} } }), "PlaylistVideoThumbnail"),
            (json!({ "premiereTrailerBadgeRenderer": { "label": { "runs": [{ "text": "Trailer" }] } } }), "PremiereTrailerBadge"),
            (json!({ "productListRenderer": { "contents": [] } }), "ProductList"),
            // Batch 12: Products & Metadata
            (json!({ "productListHeaderRenderer": { "suppressPaddingDisclaimer": true } }), "ProductListHeader"),
            (json!({ "productListItemRenderer": { "stayInApp": true } }), "ProductListItem"),
            (json!({ "profileColumnStatsRenderer": { "items": [] } }), "ProfileColumnStats"),
            (json!({ "profileColumnStatsEntryRenderer": { "label": { "runs": [{ "text": "Views" }] } } }), "ProfileColumnStatsEntry"),
            (json!({ "quizRenderer": { "choices": [] } }), "Quiz"),
            (json!({ "recognitionShelfRenderer": { "surface": "SURFACE" } }), "RecognitionShelf"),
            (json!({ "relatedChipCloudRenderer": { "showProminentChips": true } }), "RelatedChipCloud"),
            (json!({ "richListHeaderRenderer": { "titleStyle": "STYLE_DEFAULT" } }), "RichListHeader"),
            (json!({ "richMetadataRenderer": { "iconType": "INFO" } }), "RichMetadata"),
            (json!({ "richMetadataRowRenderer": { "contents": [] } }), "RichMetadataRow"),
            (json!({ "searchBoxRenderer": { "placeholderText": { "runs": [{ "text": "Search" }] } } }), "SearchBox"),
            (json!({ "searchFilterOptionsDialogRenderer": { "groups": [] } }), "SearchFilterOptionsDialog"),
            // Batch 12: Search & Settings
            (json!({ "searchHeaderRenderer": { "chipBar": {} } }), "SearchHeader"),
            (json!({ "searchSuggestionRenderer": { "iconType": "SEARCH" } }), "SearchSuggestion"),
            (json!({ "searchSuggestionsSectionRenderer": { "contents": [] } }), "SearchSuggestionsSection"),
            (json!({ "secondarySearchContainerRenderer": { "targetId": "sec1" } }), "SecondarySearchContainer"),
            (json!({ "sectionHeaderView": { "headline": { "runs": [{ "text": "Header" }] } } }), "SectionHeaderView"),
            (json!({ "segmentedLikeDislikeButtonRenderer": { "likeButton": {} } }), "SegmentedLikeDislikeButton"),
            (json!({ "segmentedLikeDislikeButtonView": { "iconType": "LIKE" } }), "SegmentedLikeDislikeButtonView"),
            (json!({ "settingBooleanRenderer": { "itemId": "b1" } }), "SettingBoolean"),
            (json!({ "settingsCheckboxRenderer": { "enabled": true } }), "SettingsCheckbox"),
            (json!({ "settingsOptionsRenderer": { "text": "Options" } }), "SettingsOptions"),
            (json!({ "settingsSidebarRenderer": { "items": [] } }), "SettingsSidebar"),
            (json!({ "settingsSwitchRenderer": { "enabled": true } }), "SettingsSwitch"),
            // Batch 13: Shares & Columns
            (json!({ "sharePanelHeaderRenderer": { "title": {} } }), "SharePanelHeader"),
            (json!({ "sharePanelTitleV15Renderer": { "title": { "runs": [{ "text": "Share" }] } } }), "SharePanelTitleV15"),
            (json!({ "shareTargetRenderer": { "serviceName": "COPY" } }), "ShareTarget"),
            (json!({ "sheetView": { "header": {} } }), "SheetView"),
            (json!({ "showCustomThumbnailRenderer": { "thumbnail": {} } }), "ShowCustomThumbnail"),
            (json!({ "simpleCardContentRenderer": { "image": {} } }), "SimpleCardContent"),
            (json!({ "simpleCardTeaserRenderer": { "prominent": true } }), "SimpleCardTeaser"),
            (json!({ "simpleTextSectionRenderer": { "lines": [] } }), "SimpleTextSection"),
            (json!({ "singleColumnBrowseResultsRenderer": { "tabs": [] } }), "SingleColumnBrowseResults"),
            (json!({ "singleColumnMusicWatchNextResultsRenderer": { "contents": {} } }), "SingleColumnMusicWatchNextResults"),
            (json!({ "singleHeroImageRenderer": { "thumbnails": {} } }), "SingleHeroImage"),
            (json!({ "slimOwnerRenderer": { "thumbnail": {} } }), "SlimOwner"),
            // Batch 13: Filters & Subscriptions
            (json!({ "sortFilterHeaderRenderer": { "filterMenu": {} } }), "SortFilterHeader"),
            (json!({ "sortFilterSubMenuRenderer": { "title": "Sort" } }), "SortFilterSubMenu"),
            (json!({ "startAtRenderer": { "startAtOptionLabel": { "runs": [{ "text": "Start at" }] } } }), "StartAt"),
            (json!({ "structuredDescriptionContentRenderer": { "items": [] } }), "StructuredDescriptionContent"),
            (json!({ "structuredDescriptionPlaylistLockupRenderer": { "maxLinesTitle": 2.0 } }), "StructuredDescriptionPlaylistLockup"),
            (json!({ "subFeedOptionRenderer": { "isSelected": true } }), "SubFeedOption"),
            (json!({ "subFeedSelectorRenderer": { "options": [] } }), "SubFeedSelector"),
            (json!({ "subscribeButtonRenderer": { "subscribed": true } }), "SubscribeButton"),
            (json!({ "subscribeButtonView": { "disableNotificationBell": true } }), "SubscribeButtonView"),
            (json!({ "tabbedRenderer": { "contents": {} } }), "Tabbed"),
            (json!({ "tabbedSearchResultsRenderer": { "tabs": [] } }), "TabbedSearchResults"),
            (json!({ "textCarouselItemView": { "iconName": "HOT" } }), "TextCarouselItemView"),
            // Batch 13: Thumbnail Overlays & Badges
            (json!({ "textFieldView": { "displayProperties": {} } }), "TextFieldView"),
            (json!({ "thirdPartyShareTargetSectionRenderer": { "shareTargets": [] } }), "ThirdPartyShareTargetSection"),
            (json!({ "thumbnailBadgeView": { "text": "HD" } }), "ThumbnailBadgeView"),
            (json!({ "thumbnailBottomOverlayView": { "badges": [] } }), "ThumbnailBottomOverlayView"),
            (json!({ "thumbnailHoverOverlayToggleActionsView": { "buttons": [] } }), "ThumbnailHoverOverlayToggleActionsView"),
            (json!({ "thumbnailHoverOverlayView": { "style": "DEFAULT" } }), "ThumbnailHoverOverlayView"),
            (json!({ "thumbnailLandscapePortraitRenderer": { "landscape": {}, "portrait": {} } }), "ThumbnailLandscapePortrait"),
            (json!({ "thumbnailOverlayAvatarStackView": { "avatarStack": {} } }), "ThumbnailOverlayAvatarStackView"),
            (json!({ "thumbnailOverlayBadgeView": { "badges": [] } }), "ThumbnailOverlayBadgeView"),
            (json!({ "thumbnailOverlayPinkingRenderer": { "hack": true } }), "ThumbnailOverlayPinking"),
            (json!({ "thumbnailOverlayPlaybackStatusRenderer": { "texts": [] } }), "ThumbnailOverlayPlaybackStatus"),
            (json!({ "thumbnailOverlayProgressBarView": { "startPercent": 50.0 } }), "ThumbnailOverlayProgressBarView"),
            // Batch 13: Tickets & Transcripts
            (json!({ "thumbnailOverlayResumePlaybackRenderer": { "percentDurationWatched": 45.0 } }), "ThumbnailOverlayResumePlayback"),
            (json!({ "thumbnailOverlayTitleView": { "title": "Overlay Title" } }), "ThumbnailOverlayTitleView"),
            (json!({ "thumbnailView": { "image": {} } }), "ThumbnailView"),
            (json!({ "ticketEventRenderer": { "hasMultipleOffers": false } }), "TicketEvent"),
            (json!({ "ticketShelfRenderer": { "useCalendarAvatar": true } }), "TicketShelf"),
            (json!({ "titleAndButtonListHeaderRenderer": { "title": { "runs": [{ "text": "Header" }] } } }), "TitleAndButtonListHeader"),
            (json!({ "toggleButtonView": { "isTogglingDisabled": false } }), "ToggleButtonView"),
            (json!({ "toggleFormFieldRenderer": { "toggled": true } }), "ToggleFormField"),
            (json!({ "toggleMenuServiceItemRenderer": { "iconType": "LIKE" } }), "ToggleMenuServiceItem"),
            (json!({ "tooltipRenderer": { "targetId": "tip1" } }), "Tooltip"),
            (json!({ "transcriptRenderer": { "content": {} } }), "Transcript"),
            (json!({ "transcriptFooterRenderer": { "languageMenu": {} } }), "TranscriptFooter"),
            // Batch 14: Transcripts & Watch Columns
            (json!({ "transcriptSearchBoxRenderer": { "formattedPlaceholder": { "runs": [{ "text": "Search" }] } } }), "TranscriptSearchBox"),
            (json!({ "transcriptSearchPanelRenderer": { "targetId": "p1" } }), "TranscriptSearchPanel"),
            (json!({ "transcriptSectionHeaderRenderer": { "startMs": "0" } }), "TranscriptSectionHeader"),
            (json!({ "transcriptSegmentRenderer": { "startMs": "0" } }), "TranscriptSegment"),
            (json!({ "transcriptSegmentListRenderer": { "touchCaptionsEnabled": true } }), "TranscriptSegmentList"),
            (json!({ "twoColumnBrowseResultsRenderer": { "tabs": [] } }), "TwoColumnBrowseResults"),
            (json!({ "twoColumnSearchResultsRenderer": { "targetId": "sr1" } }), "TwoColumnSearchResults"),
            (json!({ "twoColumnWatchNextResults": { "results": [] } }), "TwoColumnWatchNextResults"),
            (json!({ "unifiedSharePanelRenderer": { "sharePanelVersion": 1 } }), "UnifiedSharePanel"),
            (json!({ "universalWatchCardRenderer": { "collapsedLabel": { "runs": [{ "text": "Card" }] } } }), "UniversalWatchCard"),
            (json!({ "uploadTimeFactoidRenderer": { "factoid": {} } }), "UploadTimeFactoid"),
            (json!({ "upsellDialogRenderer": { "isVisible": true } }), "UpsellDialog"),
            // Batch 14: Video Sections & Watch Cards
            (json!({ "verticalWatchCardListRenderer": { "items": [] } }), "VerticalWatchCardList"),
            (json!({ "videoAttributesSectionView": { "headerTitle": "Attributes" } }), "VideoAttributesSectionView"),
            (json!({ "videoDescriptionCourseSectionRenderer": { "mediaLockups": [] } }), "VideoDescriptionCourseSection"),
            (json!({ "videoDescriptionInfocardsSectionRenderer": { "channelAvatar": {} } }), "VideoDescriptionInfocardsSection"),
            (json!({ "videoDescriptionMusicSectionRenderer": { "carouselLockups": [] } }), "VideoDescriptionMusicSection"),
            (json!({ "videoDescriptionTranscriptSectionRenderer": { "primaryButton": {} } }), "VideoDescriptionTranscriptSection"),
            (json!({ "videoDescriptionYouchatSectionView": { "primaryButton": {} } }), "VideoDescriptionYouchatSectionView"),
            (json!({ "videoMetadataCarouselView": { "carouselTitles": [] } }), "VideoMetadataCarouselView"),
            (json!({ "viewCountFactoidRenderer": { "viewCountType": "LIVE" } }), "ViewCountFactoid"),
            (json!({ "watchCardRichHeaderRenderer": { "style": "HERO" } }), "WatchCardRichHeader"),
            (json!({ "watchCardSectionSequenceRenderer": { "lists": [] } }), "WatchCardSectionSequence"),
            (json!({ "watchNextEndScreenRenderer": { "results": [] } }), "WatchNextEndScreen"),
            // Batch 14: Comments & Endpoints Extended
            (json!({ "watchNextTabbedResultsRenderer": { "tabs": [] } }), "WatchNextTabbedResults"),
            (json!({ "ypcTrailerRenderer": { "videoMessage": "Trailer" } }), "YpcTrailer"),
            (json!({ "commandExecutorCommand": { "commands": [] } }), "CommandExecutorCommand"),
            (json!({ "getKidsBlocklistPickerCommand": { "blockedForKidsContent": "BLOCK" } }), "GetKidsBlocklistPickerCommand"),
            (json!({ "showDialogCommand": { "removeDefaultPadding": true } }), "ShowDialogCommand"),
            (json!({ "commentDialogRenderer": { "authorThumbnail": {} } }), "CommentDialog"),
            (json!({ "commentReplyDialogRenderer": { "authorThumbnail": {} } }), "CommentReplyDialog"),
            (json!({ "emojiPickerRenderer": { "categories": [] } }), "EmojiPicker"),
            (json!({ "voiceReplyContainerView": { "transcriptText": { "runs": [{ "text": "Voice" }] } } }), "VoiceReplyContainerView"),
            (json!({ "addToPlaylistEndpoint": { "playlistId": "WL" } }), "AddToPlaylistEndpoint"),
            (json!({ "addToPlaylistServiceEndpoint": { "playlistId": "WL" } }), "AddToPlaylistServiceEndpoint"),
            (json!({ "createCommentEndpoint": { "commentText": "Nice video" } }), "CreateCommentEndpoint"),
            // Batch 14: Endpoint Commands
            (json!({ "createPlaylistServiceEndpoint": { "title": "New PL" } }), "CreatePlaylistServiceEndpoint"),
            (json!({ "deletePlaylistEndpoint": { "playlistId": "PL1" } }), "DeletePlaylistEndpoint"),
            (json!({ "feedbackEndpoint": { "feedbackToken": "tok" } }), "FeedbackEndpoint"),
            (json!({ "getAccountsListInnertubeEndpoint": { "requestType": "TYPE" } }), "GetAccountsListInnertubeEndpoint"),
            (json!({ "hideEngagementPanelEndpoint": { "panelIdentifier": "id1" } }), "HideEngagementPanelEndpoint"),
            (json!({ "liveChatItemContextMenuEndpoint": { "params": "p1" } }), "LiveChatItemContextMenuEndpoint"),
            (json!({ "modifyChannelNotificationPreferenceEndpoint": { "params": "p2" } }), "ModifyChannelNotificationPreferenceEndpoint"),
            (json!({ "performCommentActionEndpoint": { "actions": [] } }), "PerformCommentActionEndpoint"),
            (json!({ "playlistEditEndpoint": { "playlistId": "PL2" } }), "PlaylistEditEndpoint"),
            (json!({ "prefetchWatchCommand": { "videoId": "v1" } }), "PrefetchWatchCommand"),
            (json!({ "shareEndpoint": { "serializedShareEntity": "ent" } }), "ShareEndpoint"),
            (json!({ "shareEntityEndpoint": { "serializedShareEntity": "ent2" } }), "ShareEntityEndpoint"),
            // Batch 15: Menus & Mobile Topbar
            (json!({ "menuFlexibleItemRenderer": { "menuItem": {} } }), "MenuFlexibleItem"),
            (json!({ "menuNavigationItemRenderer": { "text": { "runs": [{ "text": "Nav" }] } } }), "MenuNavigationItem"),
            (json!({ "menuPopupRenderer": { "items": [] } }), "MenuPopup"),
            (json!({ "menuServiceItemRenderer": { "text": { "runs": [{ "text": "Service" }] } } }), "MenuServiceItem"),
            (json!({ "menuServiceItemDownloadRenderer": { "hasSeparator": false } }), "MenuServiceItemDownload"),
            (json!({ "multiPageMenuRenderer": { "sections": [] } }), "MultiPageMenu"),
            (json!({ "multiPageMenuNotificationSectionRenderer": { "items": [] } }), "MultiPageMenuNotificationSection"),
            (json!({ "simpleMenuHeaderRenderer": { "buttons": [] } }), "SimpleMenuHeader"),
            (json!({ "mobileTopbarRenderer": { "buttons": [] } }), "MobileTopbar"),
            (json!({ "multiPageMenuSectionRenderer": { "items": [] } }), "MultiPageMenuSection"),
            (json!({ "pivotBarRenderer": { "items": [] } }), "PivotBar"),
            (json!({ "pivotBarItemRenderer": { "pivotIdentifier": "p1" } }), "PivotBarItem"),
            (json!({ "topbarMenuButtonRenderer": { "targetId": "t1" } }), "TopbarMenuButton"),
            // Batch 15: Livechat Actions & Collaboration
            (json!({ "replaceLiveChatAction": { "toReplace": "id1" } }), "ReplaceLiveChatAction"),
            (json!({ "updateDateTextAction": { "dateText": { "runs": [{ "text": "Today" }] } } }), "UpdateDateTextAction"),
            (json!({ "updateDescriptionAction": { "description": { "runs": [{ "text": "Desc" }] } } }), "UpdateDescriptionAction"),
            (json!({ "updateTitleAction": { "title": { "runs": [{ "text": "Title" }] } } }), "UpdateTitleAction"),
            (json!({ "updateToggleButtonTextAction": { "buttonId": "btn1" } }), "UpdateToggleButtonTextAction"),
            (json!({ "updateViewershipAction": { "viewCount": {} } }), "UpdateViewershipAction"),
            (json!({ "bumperUserEduContentView": { "text": { "runs": [{ "text": "Edu" }] } } }), "BumperUserEduContentView"),
            (json!({ "pdgReplyButtonView": { "replyCountEntityKey": "k1" } }), "PdgReplyButtonView"),
            (json!({ "playlistCollaborationFormSchema": { "id": "f1" } }), "PlaylistCollaborationFormSchema"),
            (json!({ "playlistCollaborationViewModelPlaylistCollaboratorData": { "externalChannelId": "c1" } }), "PlaylistCollaborationViewModelPlaylistCollaboratorData"),
            (json!({ "subscriptionButton": { "subscribed": true } }), "SubscriptionButton"),
            (json!({ "commandContext": { "onTap": {} } }), "CommandContext"),
            // Batch 15: Endpoints Primitives & Kids
            (json!({ "shareEntityServiceEndpoint": { "serializedShareEntity": "ent3" } }), "ShareEntityServiceEndpoint"),
            (json!({ "signalServiceEndpoint": { "signal": "REFRESH" } }), "SignalServiceEndpoint"),
            (json!({ "unsubscribeEndpoint": { "channelIds": ["c1"] } }), "UnsubscribeEndpoint"),
            (json!({ "watchNextEndpoint": { "videoId": "v1" } }), "WatchNextEndpoint"),
            (json!({ "accessibilityContext": { "contextData": {} } }), "AccessibilityContext"),
            (json!({ "accessibilityData": { "label": "A11y" } }), "AccessibilityData"),
            (json!({ "childElement": { "text": "Child" } }), "ChildElement"),
            (json!({ "emojiRun": { "text": "smile" } }), "EmojiRun"),
            (json!({ "rendererContext": { "commandContext": {} } }), "RendererContext"),
            (json!({ "anchoredSectionRenderer": { "categoryType": "music" } }), "AnchoredSection"),
            (json!({ "kidsBlocklistPickerRenderer": { "childRows": [] } }), "KidsBlocklistPicker"),
            (json!({ "kidsBlocklistPickerItemRenderer": { "blockedEntityKey": "k2" } }), "KidsBlocklistPickerItem"),
            // Batch 15: Direct Primitives & Core Variants
            (json!({ "musicResponsiveListItemRenderer": { "flexColumns": [] } }), "MusicResponsiveListItem"),
            (json!({ "navigationEndpoint": { "watchEndpoint": { "videoId": "v1" } } }), "NavigationEndpoint"),
            (json!({ "thumbnailOverlayTimeStatusRenderer": { "text": { "runs": [{ "text": "3:45" }] } } }), "ThumbnailOverlayTimeStatus"),
            (json!({ "browseEndpoint": { "browseId": "FEwhat_to_watch" } }), "BrowseEndpoint"),
            (json!({ "likeEndpoint": { "status": "LIKE" } }), "LikeEndpoint"),
            (json!({ "reelWatchEndpoint": { "videoId": "reel1" } }), "ReelWatchEndpoint"),
            (json!({ "searchEndpoint": { "query": "rust" } }), "SearchEndpoint"),
            (json!({ "subscribeEndpoint": { "channelIds": ["c1"] } }), "SubscribeEndpoint"),
            (json!({ "watchEndpoint": { "videoId": "watch1" } }), "WatchEndpoint"),
            (json!({ "author": { "name": "Author" } }), "Author"),
            (json!({ "text": { "runs": [{ "text": "Sample" }] } }), "Text"),
            (json!({ "textRun": { "text": "Run" } }), "TextRun"),
            (json!({ "thumbnail": { "thumbnails": [{ "url": "https://img.jpg" }] } }), "Thumbnail"),
        ];
